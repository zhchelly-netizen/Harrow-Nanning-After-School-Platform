...
const translations = {
    "zh": {
        ...
        "warningTitle": "重要提醒",
        "warningIntro": "请确保您已完成所有相关类别的记录补全，并仔细核对信息无误后再进行意愿确认。如果您的孩子没有相应的板块数据用以申请半奖或以上的奖学金，错误的申请将导致您的孩子直接无缘奖学金。",
        "honourConcept": "真实 · 正直",
        "honourExample": "（6年级及以上）如果孩子确认申请了全奖项，但是数据库清晰完成后，只有两个类别的成绩有效，这会导致孩子直接落榜。低级别奖池将不再兼容，机会留给主动进入该级别奖池的学生。请对自己的野心和结果负责。",
        "humilityConcept": "鼓励谦和",
        "humilityExample": "如果孩子仅申请了优才，但是数据库里有更优秀的板块成绩，我们会保留孩子获得更高级别奖项的可能。",
        "warningFooter": "保守、真实、不要贪心，关注孩子的自身实际情况。",
        "countdownTitle": "意愿确认截止倒计时",
        "hours": "时",
        "minutes": "分",
        "seconds": "秒",
        "deadlinePrefix": "截止时间：",
        "deadlineDate": "2026年6月12日 17:00",
        "countdownNotice": "我们将在倒计时结束后，开启奖学金的评审工作，届时您将无法再确认意愿。我们将使用您的意愿、孩子的资格以及仍可能更新的数据，进行奖学金的审核发放。",
    ...
    "en": {
        ...
        "warningIntro": "Please ensure you have completed all relevant category records and verified all information before confirming your intention. If your child does not have the relevant category data to apply for a half scholarship or above, an incorrect application will result in your child being directly excluded from the scholarship.",
        "honourConcept": "Truth · Integrity",
        "honourExample": "(G6 and above) If your child confirms intention for a full scholarship, but after the database is cleaned, only two categories can be validated, this will result in your child being directly rejected. Lower-level scholarship pools will not be open for higher level droppers, and opportunities will be reserved for students who choose to enter that level. Please be responsible for your ambition and results.",
        "humilityConcept": "Encouraging Humility",
        "humilityExample": "If your child only applies for the Talent Scholarship, but the database contains more outstanding category scores, we will retain the possibility of your child receiving a higher-level scholarship.",
        "warningFooter": "Be conservative, truthful, and not greedy. Focus on your child's actual situation.",
        "countdownTitle": "Intention Confirmation Deadline",
        "hours": "Hours",
        "minutes": "Minutes",
        "seconds": "Seconds",
        "deadlinePrefix": "Deadline: ",
        "deadlineDate": "12 June 2026, 17:00",
        "countdownNotice": "After the countdown ends, we will commence the scholarship review process, and you will no longer be able to confirm your intention. We will use your intention, your child's eligibility, and any updated data to determine scholarship awards.",
        ...
        "confirmationTitle": "Intention Confirmation",
