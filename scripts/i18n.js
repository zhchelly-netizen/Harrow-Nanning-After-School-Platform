...
const translations = {
    "zh": {
        ...
        "backToModify": "← 返回修改",
        "complete": "完成 ✓",
        "dashboardPageTitle": "奖学金申请通道",
        "warningTitle": "重要提醒",
        "warningIntro": "为了孩子的奖学金申请更加顺利，建议您在确认意愿前，检查是否已补全所有相关记录。如果孩子目前没有「半奖及以上」奖学金所需的具体数据，请谨慎提交申请，避免因条件不符而遗憾错失评选机会。",
        "honourConcept": "真实 · 正直",
        "honourExample": "若您综合点亮多个板块并申请了较高等级的奖学金，但因数据调整后实际板块未达该等级标准，您将无法获得奖学金（将不予顺位降级，以确保原本即符合该等级标准的申请者之权益）。",
        "humilityConcept": "鼓励谦和",
        "humilityExample": "若您提交的材料足以支持更高级别的奖学金，但您未申请该等级，我们将在审核中酌情为您「升舱」。",
        "warningFooter": "保守、真实、不要贪心，关注孩子的自身实际情况。",
        "countdownTitle": "意愿确认已截止",
        "hours": "时",
        "minutes": "分",
        "seconds": "秒",
        "deadlinePrefix": "截止时间：",
        "deadlineDate": "2026年6月12日 17:00",
        "countdownNotice": "意愿确认已于2026年6月12日17:00截止，不再接受新的确认。奖学金评审工作即将开始。",
        "recordCompletionTitle": "记录补全",
        "recordCompletionDesc": "请根据您孩子实际参与的活动类别，补全相应记录。记录将用于奖学金评审。",
        "leadershipRecord": "领导力记录补全",
        "artsRecord": "艺术类记录补全",
        "musicPerformingArts": "音表艺术",
        "visualArts": "视觉艺术",
        "sportsRecord": "竞技体育记录补全",
        "academicRecord": "学术竞赛记录补全",
        "confirmationTitle": "意愿确认（已截止）",
        "confirmationDesc": "意愿确认已经截止，不再接受新的确认。",
        "finalConfirmation": "意愿确认已截止",
    ...
    "en": {
        ...
        "complete": "Complete ✓",
        "dashboardPageTitle": "Scholarship Application Portal",
        "warningTitle": "Important Notice",
        "warningIntro": "To ensure a smooth scholarship application for your child, we recommend double-checking that all relevant records are complete before confirming your preference. Please note that applying for a \"Half Scholarship or above\" requires specific supporting data. If your child does not currently have the necessary data, we kindly suggest proceeding with caution to avoid missing out on this opportunity due to ineligibility.",
        "honourConcept": "Truth · Integrity",
        "honourExample": "If you have demonstrated achievements across multiple areas and applied for a higher-tier scholarship, but your adjusted area does not meet the threshold for that tier after data review, you will not qualify for scholarship (no automatic downgrade will be applied to protect the legitimate interests of applicants who originally qualified for that tier).",
        "humilityConcept": "Encouraging Humility",
        "humilityExample": "If the materials you submit qualify you for a higher-tier scholarship, but you did not apply for that tier, we will, at our discretion, upgrade you to the appropriate tier during the review process.",
        "warningFooter": "Be conservative, truthful, and not greedy. Focus on your child's actual situation.",
        "countdownTitle": "Intention Confirmation Closed",
        "hours": "Hours",
        "minutes": "Minutes",
        "seconds": "Seconds",
        "deadlinePrefix": "Deadline: ",
        "deadlineDate": "12 June 2026, 17:00",
        "countdownNotice": "The intention confirmation period closed on 12 June 2026 at 17:00. No new confirmations are accepted. Scholarship review is about to begin.",
        "recordCompletionTitle": "Record Completion",
        "recordCompletionDesc": "Please complete records for the categories your child has actually participated in. Records will be used for scholarship evaluation.",
        "leadershipRecord": "Leadership Record Completion",
        "artsRecord": "Arts Record Completion",
        "musicPerformingArts": "Music & Performing Arts",
        "visualArts": "Visual Arts",
        "sportsRecord": "Sports Record Completion",
        "academicRecord": "Academic Competition Record Completion",
        "confirmationTitle": "Intention Confirmation (Closed)",
        "confirmationDesc": "The intention confirmation period has closed. No new confirmations are accepted.",
        "finalConfirmation": "Confirmation Closed",
